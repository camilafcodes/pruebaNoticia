      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="md:hidden">
          <div className="flex items-center justify-between h-12">
            ...
            {/* Hamburger menu (opcional para más opciones) */}
            <button
              className="flex-shrink-0 ml-2 p-2 rounded-md text-red-100 hover:text-white hover:bg-red-700 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-red-400"
